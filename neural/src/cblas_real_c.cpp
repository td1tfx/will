...
void cblas_swap(const int N, float* X, const int incX, float* Y, const int incY)
{
...
void cblas_rotmg(double* d1, double* d2, double* b1, const double b2, double* P)
{
...
void cblas_gbmv(const enum CBLAS_ORDER order, const enum CBLAS_TRANSPOSE TransA,
                const int M, const int N, const int KL, const int KU, const float alpha,
...
void cblas_gbmv(const enum CBLAS_ORDER order, const enum CBLAS_TRANSPOSE TransA,
                const int M, const int N, const int KL, const int KU, const double alpha,
...
void cblas_gbmv(const enum CBLAS_TRANSPOSE TransA, const int M, const int N,
                ...
                const float* X, const int incX, const float beta, float* Y, const int incY)
{
    cblas_sgbmv(CblasColMajor, TransA, M, N, KL, KU, alpha, A, lda, X, incX, beta,
                Y, incY);
}
...
void cblas_gbmv(const enum CBLAS_TRANSPOSE TransA, const int M, const int N,
                ...
                const double* X, const int incX, const double beta, double* Y, const int incY)
{
    cblas_dgbmv(CblasColMajor, TransA, M, N, KL, KU, alpha, A, lda, X, incX, beta,
                Y, incY);
}
...
void cblas_spmv(const enum CBLAS_UPLO Uplo, const int N, const float alpha,
                const float* Ap, const float* X, const int incX, const float beta, float* Y,
                const int incY)
{
...
void cblas_spmv(const enum CBLAS_UPLO Uplo, const int N, const double alpha,
                const double* Ap, const double* X, const int incX, const double beta, double* Y,
                const int incY)
{
...
void cblas_gemm(const enum CBLAS_TRANSPOSE TransA,
                ...
                const float beta, float* C, const int ldc)
{
    cblas_sgemm(CblasColMajor, TransA, TransB, M, N, K, alpha, A, lda, B, ldb, beta,
                C, ldc);
}
...
{
    cblas_ssymm(CblasColMajor, Side, Uplo, M, N, alpha, A, lda, B, ldb, beta, C,
                ldc);
}
...
void cblas_syr2k(const enum CBLAS_UPLO Uplo, const enum CBLAS_TRANSPOSE Trans,
                 ...
                 const float* B, const int ldb, const float beta, float* C, const int ldc)
{
    cblas_ssyr2k(CblasColMajor, Uplo, Trans, N, K, alpha, A, lda, B, ldb, beta, C,
                 ldc);
}
...
void cblas_trmm(const enum CBLAS_SIDE Side, const enum CBLAS_UPLO Uplo,
                ...
                const int ldb)
{
    cblas_strmm(CblasColMajor, Side, Uplo, TransA, Diag, M, N, alpha, A, lda, B,
                ldb);
}
...
void cblas_trsm(const enum CBLAS_SIDE Side, const enum CBLAS_UPLO Uplo,
                ...
                const int ldb)
{
    cblas_strsm(CblasColMajor, Side, Uplo, TransA, Diag, M, N, alpha, A, lda, B,
                ldb);
}
...
void cblas_gemm(const enum CBLAS_TRANSPOSE TransA,
                ...
                const int ldb, const double beta, double* C, const int ldc)
{
    cblas_dgemm(CblasColMajor, TransA, TransB, M, N, K, alpha, A, lda, B, ldb, beta,
                C, ldc);
}
...
{
    cblas_dsymm(CblasColMajor, Side, Uplo, M, N, alpha, A, lda, B, ldb, beta, C,
                ldc);
}
...
void cblas_syr2k(const enum CBLAS_UPLO Uplo, const enum CBLAS_TRANSPOSE Trans,
                 ...
                 const double* B, const int ldb, const double beta, double* C, const int ldc)
{
    cblas_dsyr2k(CblasColMajor, Uplo, Trans, N, K, alpha, A, lda, B, ldb, beta, C,
                 ldc);
}
...
void cblas_trmm(const enum CBLAS_SIDE Side, const enum CBLAS_UPLO Uplo,
                ...
                const int ldb)
{
    cblas_dtrmm(CblasColMajor, Side, Uplo, TransA, Diag, M, N, alpha, A, lda, B,
                ldb);
}
...
void cblas_trsm(const enum CBLAS_SIDE Side, const enum CBLAS_UPLO Uplo,
                ...
                const int ldb)
{
    cblas_dtrsm(CblasColMajor, Side, Uplo, TransA, Diag, M, N, alpha, A, lda, B,
                ldb);
}
